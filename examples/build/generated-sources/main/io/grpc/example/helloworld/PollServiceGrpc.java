...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.example.helloworld.PollRequest,
      io.grpc.example.helloworld.PollResponse> METHOD_CREATE_POLL =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "CreatePoll",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.example.helloworld.PollRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.example.helloworld.PollResponse.PARSER));
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.example.helloworld.PollRequest,
        io.grpc.example.helloworld.PollResponse> createPoll;

    private PollServiceServiceDescriptor() {
      createPoll = createMethodDescriptor(
          "grpc.example.helloworld.PollService", METHOD_CREATE_POLL);
    }

    @SuppressWarnings("unchecked")
    private PollServiceServiceDescriptor(
        java.util.Map<java.lang.String, io.grpc.MethodDescriptor<?, ?>> methodMap) {
      createPoll = (io.grpc.MethodDescriptor<io.grpc.example.helloworld.PollRequest,
          io.grpc.example.helloworld.PollResponse>) methodMap.get(
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.example.helloworld.PollRequest request,
        io.grpc.stub.StreamObserver<io.grpc.example.helloworld.PollResponse> responseObserver);
  }

  public static interface PollServiceBlockingClient {

    public io.grpc.example.helloworld.PollResponse createPoll(io.grpc.example.helloworld.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.example.helloworld.PollResponse> createPoll(
        io.grpc.example.helloworld.PollRequest request);
  }
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("grpc.example.helloworld.PollService")
      .addMethod(createMethodDefinition(
          METHOD_CREATE_POLL,
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.example.helloworld.PollRequest,
                io.grpc.example.helloworld.PollResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.example.helloworld.PollRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.example.helloworld.PollResponse> responseObserver) {
