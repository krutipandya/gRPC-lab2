...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.example.poll.PollRequest,
      io.grpc.example.poll.PollResponse> METHOD_CREATE_POLL =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "CreatePoll",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.example.poll.PollRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.example.poll.PollResponse.PARSER));
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.example.poll.PollRequest,
        io.grpc.example.poll.PollResponse> createPoll;
    ...
    private PollServiceServiceDescriptor(
      ...
      createPoll = (io.grpc.MethodDescriptor<io.grpc.example.poll.PollRequest,
          io.grpc.example.poll.PollResponse>) methodMap.get(
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.example.poll.PollRequest request,
        io.grpc.stub.StreamObserver<io.grpc.example.poll.PollResponse> responseObserver);
  }

  public static interface PollServiceBlockingClient {

    public io.grpc.example.poll.PollResponse createPoll(io.grpc.example.poll.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.example.poll.PollResponse> createPoll(
        io.grpc.example.poll.PollRequest request);
  }
      ...
      .addMethod(createMethodDefinition(
          ...
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.example.poll.PollRequest,
                io.grpc.example.poll.PollResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.example.poll.PollRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.example.poll.PollResponse> responseObserver) {
